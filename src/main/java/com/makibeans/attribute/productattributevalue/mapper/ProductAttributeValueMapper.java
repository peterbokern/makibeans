...
public interface ProductAttributeValueMapper {
    ...
    @Mapping(source = "productAttribute.categoryAttribute.attribute.id",    target = "attributeId")
    @Mapping(source = "productAttribute.categoryAttribute.attribute.name",  target = "attributeName")
