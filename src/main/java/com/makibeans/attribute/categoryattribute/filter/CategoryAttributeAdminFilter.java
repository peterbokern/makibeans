...
public class CategoryAttributeAdminFilter extends CategoryAttributePublicFilter {

    @Filter(path = "required", type = { Filter.Operation.EQ }, sortable = true, filterable = true)
