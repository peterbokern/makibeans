package com.makibeans.attribute.filter;
...
public class AttributeAdminFilter {
    ...
    @Filter(path = "description", type = { Filter.Operation.LIKE }, sortable = true, filterable = true)
    private String description;

    @Filter(path = "dataType", type = { Filter.Operation.EQ }, sortable = true, filterable = true)
    private String dataType;

    @Filter(path = "inputType", type = { Filter.Operation.EQ }, sortable = true, filterable = true)
    private String inputType;

    @Filter(path = "slug", type = { Filter.Operation.LIKE }, sortable = true, filterable = true)
    private String slug;
