...
public class AttributeServiceImpl implements AttributeService {
    ...
    @Override
    @Transactional(readOnly = true)
    public Attribute getBySlugIncludingDeleted(String slug) {
        return repo.findBySlug(slug).orElseThrow(
                () -> new ResourceNotFoundException("Attribute with slug '" + slug + "' not found."));
    }


    @Override
    @Transactional(readOnly = true)
    public Attribute getByIdIncludingDeleted(Long id) {
    ...
    public Attribute restore(Long id) throws BadRequestException {
        Attribute attribute = getByIdIncludingDeleted(id);
