...
public class ProductAttributeAdminFilter extends ProductAttributePublicFilter {

    @Filter(path = "categoryAttribute.attribute.id", type = { Filter.Operation.EQ }, sortable = true, filterable = true)
