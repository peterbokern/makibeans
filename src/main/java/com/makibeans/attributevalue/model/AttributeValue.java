package com.makibeans.attributevalue.model;

import com.makibeans.attribute.model.Attribute;
import com.makibeans.attributevalue.validation.annotation.ValidAttributeValueForType;
...
public class AttributeValue extends Auditable {
    ...
    @Id
    @Setter(AccessLevel.NONE) //TODO: apply to all id fields
